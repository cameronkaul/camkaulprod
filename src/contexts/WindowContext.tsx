...
const defaultWindows: WindowState[] = [
  ...
  { id: 'videoWidget', title: 'Featured Work', isOpen: true, isMinimized: false, zIndex: 0, position: { x: 720, y: 60 }, size: { width: 500, height: 320 } },
  { id: 'photoWidget', title: 'Gallery', isOpen: true, isMinimized: false, zIndex: 0, position: { x: 560, y: 420 }, size: { width: 280, height: 280 } },
];
